...
public interface SysRolesDeptsDao {
     ...
     *
     * @param entities List<SysRolesDepts> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<SysRolesDepts> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<SysRolesDepts> entities);
