...
//        filterChainDefinitionMap.put("/**", "authc");
     ...
     */
    @Bean
    public MyAuthorizingRealm customAuthorizingRealm() {
        ...
        // 设置身份缓存名称前缀
        myAuthorizingRealm.setAuthenticationCacheName("userinfo_cache");
        // 开启授权缓存
        myAuthorizingRealm.setAuthorizationCachingEnabled(true);
        // 这是权限缓存名称前缀
        myAuthorizingRealm.setAuthorizationCacheName("authorization_cache");
