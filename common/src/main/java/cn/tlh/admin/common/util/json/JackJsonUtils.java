...
public class JackJsonUtils {
     ...
     * 将json结果集转化为对象
     */
    public static <T> T toObject(String jsonData, Class<T> beanType) throws JsonProcessingException {
     ...
     */
    public static <T> T toList(String jsonData, TypeReference<T> typeReference) throws JsonProcessingException {
