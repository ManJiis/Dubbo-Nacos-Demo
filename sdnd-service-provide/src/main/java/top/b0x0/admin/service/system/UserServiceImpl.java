...
import top.b0x0.admin.common.exception.myexception.EntityNotFoundException;
...
//    private final OnlineUserService onlineUserService;
    ...
    public Page<SysUser> selectList(UserQueryReqVo userQueryReqVo) {
        Page<SysUser> page = new Page<>(userQueryReqVo.getPageNum(), userQueryReqVo.getPageSize());
//        return sysUserDao.selectList(page, userQueryReqVo);
        return page;
    }

    @Override
    public PageInfo<SysUser> selectList2(UserQueryReqVo userQueryReqVo) {
        PageHelper.startPage(userQueryReqVo.getPageNum(), userQueryReqVo.getPageSize());
